...
- **[市值前1000代币监控](./TOP_1000_TOKENS_GUIDE.md)** - 新增！市值前1000代币套利监控功能
- **[订单压制功能指南](./ORDER_SUPPRESSION_GUIDE.md)** - 新增！监控特定地址并执行抢先交易

## 功能特性

- ✅ **STX (Stacks) 监控**: 实时监控 Stacks 网络交易，专注于 DEX 交易和合约调用
- ✅ **Starknet 监控**: 实时监控 Starknet 网络交易
- ✅ **订单压制功能**: 监控特定地址的交易活动，支持抢先交易（Front-running）
